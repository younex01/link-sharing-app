...
const CustomizeProfile = () => {
  ...
  return (
    <div className="relative bg-white rounded-xl  h-full flex flex-col border-2 border-black">
      <form onSubmit={handleSubmit(onSubmit)} className="relative bg-white">
        <div className="p-[24px] h-full overflow-auto  rounded-xl">
          ...
          <div className="bg-[#FAFAFA] rounded-xl w-full max-w-full p-[20px] flex flex-col items-center mt-5 gap-[12px]">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-stretch sm:items-center w-full">
              <label className="block mb-2 w-fit text-sm text-[#737373]">First name*</label>
            ...
            <div className="flex flex-col sm:flex-row sm:justify-stretch sm:items-center w-full">
              <label className="block mb-2 w-fit text-sm text-[#737373]">Last name*</label>
              <div className="sm:ml-auto sm:w-[300px]">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-stretch sm:items-center w-full ">
              <label className="block mb-2 w-fit text-sm text-[#737373]">Email</label>
              <div className="sm:ml-auto sm:w-[300px]">
